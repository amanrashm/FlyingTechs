...
import com.flyingtechs.TestManagement.controller.impl.TestControllerImpl;
...
public class TestControllerImplTest1 {
    ...
    public void getById() throws Exception {
        ...
        Mockito.when(testService.findById(ArgumentMatchers.anyLong())).thenReturn(java.util.Optional.of(test));
