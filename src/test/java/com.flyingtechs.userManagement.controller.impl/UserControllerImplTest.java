...
public class UserControllerImplTest {
    ...
    public void save() throws Exception {
        OptimisticLockException UserBuilder = null;
        Mockito.when(userMapper.asEntity(ArgumentMatchers.any())).thenReturn((User) UserBuilder.getEntity());
        Mockito.when(userService.save(ArgumentMatchers.any(User.class))).thenReturn((User) UserBuilder.getEntity());
